...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PERLDOCJP_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PERLDOCJP_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
perldocjp_server.pl - Catalyst Testserver

=head1 SYNOPSIS

perldocjp_server.pl [options]
